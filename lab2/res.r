...
pdf(file="results.pdf", height=5, width=10, bg="white")

plot(avg_results[avg_results$alg=="b1",]$n, avg_results[avg_results$alg=="b1",]$time, type="o", lty = 1, ylim = y_range,
	xlab = "Size of vector/matrix", ylab = "Computing time in miliseconds", col="blue")
...
errbar(avg_results[avg_results$alg=="b1",]$n,
	...
	avg_results[avg_results$alg=="b1",]$time+avg_results[avg_results$alg=="b1",]$sd,
	xlab="n", ylab="Computing time in miliseconds", add=TRUE)
